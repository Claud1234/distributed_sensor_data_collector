...
-- -----------------------------------------------------
-- Table `transport_ecosystem_management_db`.`frame_detection_table`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `transport_ecosystem_management_db`.`frame_detection_table` (
  `frame_id` INT NOT NULL,
  `detection_model_id` INT NOT NULL,
